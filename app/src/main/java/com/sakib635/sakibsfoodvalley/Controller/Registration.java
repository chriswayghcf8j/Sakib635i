...
public class Registration extends AppCompatActivity {
    ...
    String[] Dhaka = {"Bailey Road","Banani ","Banasree","Baridhara","Bashundhara Residential Area","Dhanmondi","Khilgaon","Uttara","Mohakhali","Mirpur"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Email = (TextInputLayout)findViewById(R.id.Emailidc);
        Pass = (TextInputLayout)findViewById(R.id.Passwordd);
        cpass = (TextInputLayout)findViewById(R.id.confirmpasss);
        mobileno = (TextInputLayout)findViewById(R.id.Mobilenumberr);
        ...
        area = (TextInputLayout)findViewById(R.id.Areas);
